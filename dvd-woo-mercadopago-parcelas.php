 ...
 * Text Domain: nuvem-automacao-woo-parcelas
...
final class DVDMercadoParcelas
{
	...
	private function filtrar($html) {
		...
		return $inicio .
			...
			// $this->floatToReal($valor).uu
				'<span class="parcelado">'.$textParcelado.'</span>'.
					'<p> <span class="desconto">'.$this->floatToReal($desconto).' Boleto (com 5% DESC)</span>'.
	...
	public function add_table_parcelamento() {
		...
		// echo plugins_url('img/bandeiras-cartoes.png');
		echo $tableParcelado;
	}
